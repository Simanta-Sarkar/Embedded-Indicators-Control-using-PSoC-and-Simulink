// ======================================================================
// MoonRider.v generated from TopDesign.cysch
// 05/21/2025 at 11:20
...
module top ;
	...
	wire [0:0] tmpOE__Left_Button_net;
	wire [0:0] tmpIO_0__Left_Button_net;
	wire [0:0] tmpINTERRUPT_0__Left_Button_net;
	electrical [0:0] tmpSIOVREF__Left_Button_net;
	...
	cy_psoc3_pins_v1_10
		...
		Left_Button
		 (.oe(tmpOE__Left_Button_net),
		  .y({1'b0}),
		  .fb({Net_435}),
		  .io({tmpIO_0__Left_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_Button_net),
		  .interrupt({tmpINTERRUPT_0__Left_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_Button_net;
	wire [0:0] tmpIO_0__Right_Button_net;
	wire [0:0] tmpINTERRUPT_0__Right_Button_net;
	electrical [0:0] tmpSIOVREF__Right_Button_net;

	cy_psoc3_pins_v1_10
		#(.id("9420b651-2b85-4a35-a909-18475882a2c5"),
		  .drive_mode(3'b010),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b1),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Right_Button
		 (.oe(tmpOE__Right_Button_net),
		  .y({1'b0}),
		  .fb({Net_436}),
		  .io({tmpIO_0__Right_Button_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_Button_net),
		  .interrupt({tmpINTERRUPT_0__Right_Button_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_Button_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};
	...
	wire [0:0] tmpOE__Left_LED_net;
	wire [0:0] tmpFB_0__Left_LED_net;
	wire [0:0] tmpIO_0__Left_LED_net;
	wire [0:0] tmpINTERRUPT_0__Left_LED_net;
	electrical [0:0] tmpSIOVREF__Left_LED_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		Left_LED
		 (.oe(tmpOE__Left_LED_net),
		  .y({Net_73}),
		  .fb({tmpFB_0__Left_LED_net[0:0]}),
		  .io({tmpIO_0__Left_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Left_LED_net),
		  .interrupt({tmpINTERRUPT_0__Left_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Left_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

	wire [0:0] tmpOE__Right_LED_net;
	wire [0:0] tmpFB_0__Right_LED_net;
	wire [0:0] tmpIO_0__Right_LED_net;
	wire [0:0] tmpINTERRUPT_0__Right_LED_net;
	electrical [0:0] tmpSIOVREF__Right_LED_net;

	cy_psoc3_pins_v1_10
		#(.id("8969edda-c23f-4b00-9dd2-023026a69b9f"),
		  .drive_mode(3'b110),
		  .ibuf_enabled(1'b1),
		  .init_dr_st(1'b0),
		  .input_clk_en(0),
		  ...
		  .input_buffer_sel(2'b00))
		Right_LED
		 (.oe(tmpOE__Right_LED_net),
		  .y({Net_102}),
		  .fb({tmpFB_0__Right_LED_net[0:0]}),
		  .io({tmpIO_0__Right_LED_net[0:0]}),
		  .siovref(tmpSIOVREF__Right_LED_net),
		  .interrupt({tmpINTERRUPT_0__Right_LED_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__Right_LED_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};


	cy_clock_v1_0
		#(.id("9c8b788e-5677-4903-bafe-564f5867ff69"),
		  .source_clock_id(""),
		  .divisor(0),
    ...
    UART_v2_50_2 UART_1 (
        ...
        .rx_clk(Net_411),
        .rx_data(Net_412),
        .rx_interrupt(Net_413),
        .tx(Net_402),
        .tx_clk(Net_414),
        .tx_data(Net_415),
        .tx_en(Net_416),
        .tx_interrupt(Net_417));
