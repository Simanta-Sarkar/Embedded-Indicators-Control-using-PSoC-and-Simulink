...
*
* \funcusage
*  \snippet Left_LED_SUT.c usage_Left_LED_Write
*******************************************************************************/
...
*
* \funcusage
*  \snippet Left_LED_SUT.c usage_Left_LED_SetDriveMode
*******************************************************************************/
...
*
* \funcusage
*  \snippet Left_LED_SUT.c usage_Left_LED_Read  
*******************************************************************************/
...
* preferred Left_LED_Read() API because the 
* Left_LED_ReadDataReg() reads the data register instead of the status 
...
*
* \funcusage
*  \snippet Left_LED_SUT.c usage_Left_LED_ReadDataReg 
*******************************************************************************/
...
/* If interrupt is connected for this Pins component */ 
    ...
    /*******************************************************************************
    * Function Name: Left_LED_SetInterruptMode
    ****************************************************************************//**
    *
    ...
    *  component. Or you may use Left_LED_INTR_ALL to configure the
    *  interrupt mode of all the pins in the Pins component.       
    *  - Left_LED_0_INTR       (First pin in the list)
    *  - Left_LED_1_INTR       (Second pin in the list)
    *  - ...
    *  - Left_LED_INTR_ALL     (All pins in Pins component)
    *
    * \param mode
    ...
    *
    * \funcusage
    *  \snippet Left_LED_SUT.c usage_Left_LED_SetInterruptMode
    *******************************************************************************/
    void Left_LED_SetInterruptMode(uint16 position, uint16 mode)
    {
		if((position & Left_LED_0_INTR) != 0u) 
		{ 
			 Left_LED_0_INTTYPE_REG = (uint8)mode; 
		}
    }
    ...
    *
    * \funcusage
    *  \snippet Left_LED_SUT.c usage_Left_LED_ClearInterrupt
    *******************************************************************************/
